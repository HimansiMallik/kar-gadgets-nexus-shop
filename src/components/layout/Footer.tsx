      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {footerSections.map((section, idx) => (
            <motion.div
              ...
              className="space-y-4"
            >
              <h3 className="text-lg font-semibold relative after:content-[''] after:absolute after:w-12 after:h-1 after:bg-shop-accent after:bottom-0 after:left-0 after:rounded-full pb-2">
                {section.title}
              </h3>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
          <div className="flex gap-4 mb-4 md:mb-0">
            <a href="#" className="w-10 h-10 rounded-full bg-gray-800 hover:bg-shop-primary transition-colors duration-300 flex items-center justify-center">
